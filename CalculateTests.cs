...
namespace calculate.Tests
{
    public class CalculateTests
    {
        ...
        [Fact]
        public void Plus_Zero_ReturnsCorrectSum()
        {
            int result = _calculate.Plus(0, 3);
        ...
        [Fact]
        public void Minus_Zero_ReturnsCorrectDifference()
        {
            int result = _calculate.Minus(5, 0);
            Assert.Equal(5, result);
        }
        ...
        [Fact]
        public void Multiple_Zero_ReturnsCorrectProduct()
        {
            int result = _calculate.Multiple(2, 0);
        ...
        {
            int result = _calculate.Divide(0, 3);
            Assert.Equal(0, result);
        }
    }
}
